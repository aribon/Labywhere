...
public class RegisterFragment extends BaseFragment
    ...
    @Bind(R.id.auth_register_form_container)
    View formContainer;
    @Bind(R.id.auth_register_edit_email)
    EditText etRegisterEmail;
    @Bind(R.id.auth_register_edit_password)
    EditText etRegisterPassword;
    @Bind(R.id.auth_register_edit_firstname)
    EditText etRegisterFirstname;
    @Bind(R.id.auth_register_edit_lastname)
